            ...
            columns=[
                CarouselColumn(
                    ...
                    actions=[
                        ...
                        URITemplateAction(
                            label='點集查看攻略1',
                            uri='https://i.imgur.com/3SEkPO9.jpg'
                        ),
                        URITemplateAction(
                            label='點集查看攻略2',
                            uri='https://i.imgur.com/3PZAnT5.jpg'
                        )
                    ]
                ),
                CarouselColumn(
                    thumbnail_image_url='https://i.imgur.com/8IxeIIV.jpg',
                    title='蜃氣樓',
                    text='週二',
                    actions=[
                        PostbackTemplateAction(
                        ...
                        URITemplateAction(
                            label='點集查看攻略1',
                            uri='https://i.imgur.com/rYWVYRp.jpg'
                        ),
                        URITemplateAction(
                            label='點集查看攻略2',
                            uri='https://i.imgur.com/VBqpP9C.jpg'
                        )
                    ]
                ),
                 CarouselColumn(
                    thumbnail_image_url='https://i.imgur.com/wf8tcsp.jpg',
                    title='土蜘蛛',
                    text='週三',
                    actions=[
                        PostbackTemplateAction(
                        ...
                        URITemplateAction(
                            label='點集查看攻略1',
                            uri='https://i.imgur.com/xcB9lSU.jpg'
                        ),
                        URITemplateAction(
                            label='點集查看攻略2',
                            uri='https://i.imgur.com/POJxFOU.jpg'
                        )
                    ]
                ),
                 CarouselColumn(
                 ...
                 CarouselColumn(
                    ...
                    actions=[
                        ...
                        URITemplateAction(
                            label='點集查看攻略1',
                            uri='https://i.imgur.com/jCsjZMQ.jpg'
                        ),
                        URITemplateAction(
                            label='點集查看攻略2',
                            uri='https://i.imgur.com/zYlcaUq.jpg'
                        )
                    ]
                ),
                 CarouselColumn(
                    ...
                    actions=[
                        ...
                        URITemplateAction(
                            label='點集查看攻略1',
                            uri='https://i.imgur.com/wM8WGiM.jpg'
                        ),
                        URITemplateAction(
                            label='無攻略2',
                            uri='https://i.imgur.com/wM8WGiM.jpg'
